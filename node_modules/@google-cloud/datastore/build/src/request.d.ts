...
export declare const transactionExpiredError = "This transaction has already expired.";
 ...
 */
export declare function getTransactionRequest(transaction: Transaction, options: RunOptions): TransactionRequestOptions;
